...
<html>
    <head>
        <title>Интернет-магазин 'Games Series' - Обратная связь</title>
        <meta charset="UTF-8">
        ...
        <script type="text/javascript" src="./script/feed-back-script.js"></script>
        <link rel="stylesheet" href="./css/feed-back-styles.css">
    ...
    <body class="mbp">
        <header class="mbp header__background">
            <div class="mbp" id="menu__search">
                <menu class="mbp" id="main__menu">
                    ...
                    <li class="mbp menu__list-item"><a class="menu__list-link menu__current" href="./feed-back.php">Обратная связь</a></li>
                </menu>
        ...
        <div id="feedBackWrapperBackground">
            <div id="feedBackWrapper">
                <div class="infoWrapper" id="firstNameWrapper"><label class="labels" id="labelFirstName">Имя</label><input type="text" class="textBoxes" id="textBoxName" placeholder="Ваше Имя"></div>
                <div class="infoWrapper" id="e-mailWrapper"><label class="labels" id="labelE-mail">E-mail</label><input type="text" class="textBoxes" id="textBoxE-mail" placeholder="Ваш e-mail"></div>
                <div class="infoWrapper" id="textAreaWrapper"><label class="labels" id="labelTextArea">Текст</label><textarea name="messageText" class="textBoxes" id="textArea" placeholder="Текст Вашего сообщения" cols="120" rows="15"></textarea></div>
                <input id="sendMessageButton" type="button" value="Отправить сообщение">
            </div>
        </div>
