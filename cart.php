...
<html>
    <head>
        <title>Интернет-магазин 'Games Series' - Корзина</title>
        <meta charset="UTF-8">
        ...
        <script type="text/javascript" src="./script/cart-script.js"></script>
    ...
    <body class="mbp">
        <header class="mbp header__background">
            <div class="mbp" id="menu__search">
                <menu class="mbp" id="main__menu">
                    ...
                    <li class="mbp menu__list-item"><a class="menu__list-link menu__current" href="./cart.php">Корзина</a></li>
        ...
        <div class="mainBlock">
            <div class="cartWrapper cartWrapperScrollbar" id="cartWrapper"></div>
